...
// Extracted loading component for better readability
const LoadingScreen = () => (
  <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white dark:bg-gray-950">
    ...
    <div className="z-10 flex flex-col items-center gap-6 text-center">
      ...
      <div className="h-10 w-10 animate-spin rounded-full border-4 border-gray-300 border-t-gray-900 dark:border-gray-700 dark:border-t-white" />

      {/* Brand */}
      <div className="flex flex-col items-center gap-2">
        <h1 className="animate-pulse bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-4xl font-extrabold tracking-tight text-transparent">
          Aura
        </h1>
