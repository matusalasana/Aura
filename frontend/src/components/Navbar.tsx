...
const Navbar = () => {
  ...
  // Mock cart count - replace with your useCart hook later
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link to="/profile" className="p-2 text-gray-900 hover:bg-gray-100 rounded-full transition-colors">
              <User className="h-5 w-5" />
            </Link>

          
<Link to="/cart" className="relative p-2 text-gray-900 hover:bg-gray-100 rounded-full transition-colors">
  ...
  {cartCount > 0 && (
    <span className="absolute -right-0.5 -top-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white">
      ...
      <div className={`fixed inset-0 z-[110] bg-black/40 backdrop-blur-sm transition-opacity duration-300 lg:hidden ${
      ...
      <div className={`fixed inset-y-0 left-0 z-[120] w-[80%] max-w-sm bg-white p-6 transition-transform duration-500 ease-out lg:hidden ${
        ...
        <div className="flex flex-col gap-6">
          ...
          <button 
            ...
            className="text-left text-sm font-bold text-red-500 uppercase tracking-widest"
          >
            Sign Out
          </button>
        </div>
